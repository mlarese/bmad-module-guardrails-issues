# Guardrails Issues (`gri`) — istruzioni di progetto
...
fonte, poi `python3 tools/build_modules.py --module gri`, poi commit qui.

## Cosa cambia rispetto al bundle

- il roster contiene solo le figure di quest'area
- le due skill del core sono rinominate: `gri-profile`, `gri-board`
